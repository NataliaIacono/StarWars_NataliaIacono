...
const VistaDetallada = () => {
    ...
    return <div>{personaje ? <CardDetalladaP key={personaje.uid} uid={personaje.uid} name={personaje.properties.name} gender={personaje.properties.gender} eye_color={personaje.properties.eye_color} birth_year={personaje.properties.birth_year} height={personaje.properties.height} skin_color={personaje.properties.skin_color} /> : <p>Personaje no encontrado</p>}</div>;
};
